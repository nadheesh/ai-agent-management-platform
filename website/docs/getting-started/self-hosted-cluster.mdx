...
helm install openchoreo-control-plane \
  ...
  --create-namespace \
  --timeout 600s \
  --values https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.8.0/deployments/single-cluster/values-cp.yaml
...
helm install openchoreo-data-plane \
  ...
  --create-namespace \
  --timeout 600s \
  --values https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.8.0/deployments/single-cluster/values-dp.yaml
...
helm install openchoreo-build-plane \
  ...
  --namespace openchoreo-build-plane \
  --timeout 600s \
  --values https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.8.0/deployments/single-cluster/values-bp.yaml
...
helm install openchoreo-observability-plane \
  ...
  --timeout 900s \
  --values https://raw.githubusercontent.com/wso2/agent-manager/amp/v0.8.0/deployments/single-cluster/values-op.yaml
